  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/admin/reports" element={<div className="page-placeholder">Reports - Coming Soon</div>} />
        <Route path="/admin/settings" element={<div className="page-placeholder">Settings - Coming Soon</div>} />
